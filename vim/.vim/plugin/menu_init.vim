...
call quickui#menu#install("&Git", [
			\ ["View &Diff\t:Gvdiffsplit", 'Gvdiffsplit'],
			\ ["View &Conflict\t:Gvdiffsplit!", 'Gvdiffsplit!'],
			\ ['&Show Log', 'Glog'],
...
call quickui#menu#install('&Tools', [
			...
			\ ['&Spell %{&spell? "Disable":"Enable"}', 'setlocal spell!', 'Toggle spell check %{&spell? "off" : "on"}'],
...
call quickui#menu#install('&Plugin', [
			\ ["N&ERDTree\t,te", 'NERDTreeToggle', 'toggle nerdtree'],
			\ ["&undoTree\t,tu", 'UndotreeToggle', 'toggle UndoTree'],
			\ ["-"],
			\ ["&Tagbar\t,tb", 'TagbarToggle', 'toggle tagbar'],
			\ ["Toggle &Vista\t,tt", 'Vista!!', ''],
			\ ["-"],
...
" hotkey
"----------------------------------------------------------------------
" 定义按两次<leader>就打开上面的目录
noremap <silent><leader><leader> :call quickui#menu#open()<cr>
nnoremap <silent><leader>k :call quickui#tools#clever_context('k', g:context_menu_k, {})<cr>
